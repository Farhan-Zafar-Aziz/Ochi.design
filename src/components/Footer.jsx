...
function Footer() {
  return (
    <div
     className="flex gap-5 w-full h-full bg-zinc-900 py-10 ">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div 
        className="headings transition-all duration-300 hover:scale-110">
        <h1 className="text-[8vw] font-semibold uppercase -mb-6 px-20 leading-none">Key-</h1>
        <h1 className="text-[6vw] font-semibold uppercase mb-[54vh] px-20 leading-none">
          Opening
        </h1>
      </div>
      <svg className="ml-20" width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="w-1/2">
    <h1 className="text-[5vw] font-semibold uppercase -mb-6 px-20 leading-none">
          Presentations
        </h1>
        <div className="flex justify-between mr-20 items-center">
            <div>
        <div className="details ml-20 mt-16">
            <h1 className="text-2xl mt-6">S:</h1>
        ...
        <div className="details ml-20 mt-6">
        ...
        <div className="details mt-6">
         ...
         <a className="block text-xl font-light" href="#">Liviv, Ukrain</a>
        </div>

        <div className="details mt-10">
        <h1 className="text-2xl mb-5">E:</h1>
