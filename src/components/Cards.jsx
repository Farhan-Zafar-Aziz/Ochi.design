  ...
  return (
    <div className="w-full h-screen bg-zinc-100 flex items-center px-10 gap-5">
      <div  className="cardcontainer h-[60vh] w-1/2">
        <div className="relative card rounded-xl w-full h-full bg-[#004D43] flex items-center justify-center transition-all duration-300 hover:scale-110">
          <svg
            className="text-[#CDEA43]"
            width="72"
            height="30"
            viewBox="0 0 72 30"
            fill="none"
          ...
          <div>
            <button className="absolute px-5 py-1 border-2 rounded-full text-[#CDEA43] border-[#CDEA43] left-10 bottom-10 ">
              2019-2024
            </button>
          </div>
        </div>
      ...
      <div className="cardcontainer flex gap-5 h-[60vh] w-1/2 ">
        <div className="card relative rounded-xl w-1/2 h-full bg-zinc-800  flex items-center justify-center transition-all duration-300 hover:scale-110">
          <img src={clutch} alt="" />
          <div>
          <button className="absolute px-5 py-1 border-2 rounded-full uppercase font-semibold text-white border-white left-10 bottom-10  hover:text-black hover:bg-white ">Rating5.0 on Cltch</button>
          </div>
        </div>
        <div className="card relative rounded-xl w-1/2 h-full bg-zinc-800 flex items-center justify-center transition-all duration-300 hover:scale-110">
            <img src={alumni} className="w-32" alt=""/>
            <div>
            <button className="absolute px-5 py-1 border-2 rounded-full uppercase font-semibold text-white border-white left-10 bottom-10 hover:text-black hover:bg-white ">Business Alumni</button>
        </div>
        </div>
      </div>
    </div>
